    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-gray-600">
          Panel operacional en tiempo real - {stats.total} transferencias registradas
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-lg border border-blue-200 bg-blue-50 p-6 shadow-sm">
          <h3 className="mb-3 text-sm font-semibold text-blue-900">Flujo principal</h3>
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
          <h3 className="mb-3 text-sm font-semibold text-gray-900">Estados críticos</h3>
          <div className="space-y-2 text-xs text-gray-700">
            ...
            <div className="flex items-center gap-2">
              <span className="inline-block h-2 w-2 rounded-full bg-red-600"></span>
              ERROR_RESERVA - Falla en reserva
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              <span className="inline-block h-2 w-2 rounded-full bg-fuchsia-600"></span>
              EN_TRANSITO_CON_INCIDENTE - Incidente durante transporte
            </div>
          </div>
        </div>
      </div>
